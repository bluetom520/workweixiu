...
namespace DockSample  //这边需要换成自己的命名空间名 
...
{ 
    ...
    { 
        ...
        { 
            ...
            newTable.Borders.Enable = 1;  //允许有边框默认没有边框(为0时报错1为实线边框2、3 为虚线边框以后的数字没试过) 
        ...
        public void MergeCell(Microsoft.Office.Interop.Word.Table table, int row1, int column1, int 
...
row2, int column2) 
        ...
        public void SetParagraph_Table(Microsoft.Office.Interop.Word.Table table, int Align, int 
...
Vertical) 
        ...
        { 
            ...
            { 
                ...
                case -1: table.Range.ParagraphFormat.Alignment = 

WdParagraphAlignment.wdAlignParagraphLeft; break;//左对齐 

                case 0: table.Range.ParagraphFormat.Alignment = 

WdParagraphAlignment.wdAlignParagraphCenter; break;//水平居中 

                case 1: table.Range.ParagraphFormat.Alignment = 

WdParagraphAlignment.wdAlignParagraphRight; break;//右对齐 
            ...
            { 
                ...
                case -1: table.Range.Cells.VerticalAlignment = 

WdCellVerticalAlignment.wdCellAlignVerticalTop; break;//顶端对齐 

                case 0: table.Range.Cells.VerticalAlignment = 

WdCellVerticalAlignment.wdCellAlignVerticalCenter; break;//垂直居中 
        ...
        public void SetFont_Table(Microsoft.Office.Interop.Word.Table table, string fontName, 
...
double size) 
        ...
        public void InsertCell(Microsoft.Office.Interop.Word.Table table, int row, int column, 
...
string value) 
        ...
        { 
            ...
            wordDoc.InlineShapes.AddPicture(picturePath, ref linkToFile, ref saveWithDocument, ref 
